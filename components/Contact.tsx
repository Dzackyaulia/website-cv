...
export default function Contact() {
  ...
  return (
    <section 
      ...
      ref={ref}
    >
      <div className={`section-enter text-center mb-16 ${isInView ? 'active' : ''}`}>
        ...
        <p className={`text-gray-400 text-lg mb-6 content-fade-enter ${isInView ? 'active' : ''} delay-100`}>Tertarik untuk berkolaborasi? Mari kita terhubung!</p>
        <div className={`w-20 h-1.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-4 content-fade-enter ${isInView ? 'active' : ''} delay-200`}></div>
        <p className={`text-gray-400 max-w-2xl mx-auto content-fade-enter ${isInView ? 'active' : ''} delay-300`}>
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-14">
        ...
        <div className={`space-y-6 content-fade-enter ${isInView ? 'active' : ''} delay-400`}>
          ...
          <div className={`group bg-gradient-to-br from-slate-700/30 to-slate-800/30 backdrop-blur-md p-7 rounded-2xl border border-slate-600/40 hover:border-blue-400/60 transition-all duration-500 hover:bg-gradient-to-br hover:from-slate-700/50 hover:to-slate-800/50 hover:shadow-2xl hover:shadow-blue-500/20 card-enter ${isInView ? 'active' : ''} hover-lift-animation`} style={{ animationDelay: isInView ? '100ms' : '0ms' }}>
            <div className="flex gap-4 items-start">
          ...
          <div className={`group bg-gradient-to-br from-slate-700/30 to-slate-800/30 backdrop-blur-md p-7 rounded-2xl border border-slate-600/40 hover:border-blue-400/60 transition-all duration-500 hover:bg-gradient-to-br hover:from-slate-700/50 hover:to-slate-800/50 hover:shadow-2xl hover:shadow-blue-500/20 card-enter ${isInView ? 'active' : ''} hover-lift-animation`} style={{ animationDelay: isInView ? '200ms' : '0ms' }}>
            <div className="flex gap-4 items-start">
        ...
        {/* Contact Form */}
        <form onSubmit={handleSubmit} className={`space-y-6 content-fade-enter ${isInView ? 'active' : ''} delay-500`}>
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-slate-700/30 border border-slate-600/40 rounded-lg text-gray-100 placeholder-gray-500 focus:bg-slate-700/50 focus:border-blue-500 focus:outline-none transition-all duration-300 focus:scale-105"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full px-4 py-3 bg-slate-700/30 border border-slate-600/40 rounded-lg text-gray-100 placeholder-gray-500 focus:bg-slate-700/50 focus:border-blue-500 focus:outline-none transition-all duration-300 focus:scale-105 resize-none"
            ></textarea>
          </div>
          ...
          <button
            type="submit"
            disabled={submitted}
            className={`w-full px-6 py-3 font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 transform hover-lift-animation ${
              submitted
