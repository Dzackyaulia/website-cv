  ...
  return (
    ...
    >
      <div className={`section-enter mb-16 ${isInView ? 'active' : ''}`}>
        ...
        <p className={`text-gray-400 text-lg mb-6 content-fade-enter ${isInView ? 'active' : ''} delay-100`}>Berikut adalah beberapa project yang telah saya kerjakan</p>
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex gap-3 mt-auto">
              <a
                href={project.github}
                className="flex-1 text-center py-2.5 bg-slate-600/40 hover:bg-blue-600 text-gray-200 hover:text-white rounded-lg transition-all duration-300 text-sm font-semibold border border-slate-500/30 hover:border-blue-500/50 hover-lift-animation"
              >
                GitHub
              </a>
              <a
                href={project.demo}
                className="flex-1 text-center py-2.5 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:shadow-lg hover:shadow-blue-500/40 text-white rounded-lg transition-all duration-300 text-sm font-semibold hover-lift-animation"
              >
                Demo
              </a>
            </div>
