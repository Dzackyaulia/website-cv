  ...
  return (
    <section id="about" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
      <div className="animate-slide-in-up mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center md:text-left animate-fade-in-up">
          <span className="gradient-text">Tentang Saya</span>
        </h2>
        <p className="text-gray-400 text-lg mb-6 animate-fade-in-up animate-delay-100">Mengenal lebih jauh tentang perjalanan saya</p>
      ...
      <div className="grid md:grid-cols-2 gap-14 lg:gap-16">
        <div className="space-y-7 animate-fade-in">
          <p className="text-gray-300 text-lg leading-relaxed font-light animate-fade-in-up">
          ...
          <p className="text-gray-300 text-lg leading-relaxed font-light animate-fade-in-up animate-delay-100">
          ...
          <div className="pt-2 animate-fade-in-up animate-delay-200">
            <a href="#contact" className="btn-primary inline-flex items-center gap-2 hover-lift-sm">
              Mari Terhubung
        ...
        <div className="space-y-6 animate-fade-in-delay">
          ...
          <div className="group bg-gradient-to-br from-slate-700/30 to-slate-800/30 backdrop-blur-md p-7 rounded-2xl border border-slate-600/40 hover:border-blue-400/60 transition-all duration-500 hover:bg-gradient-to-br hover:from-slate-700/50 hover:to-slate-800/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105 animate-fade-in-scale" style={{ animationDelay: '100ms' }}>
            <div className="flex items-start gap-4">
              <div className="text-4xl group-hover:scale-110 group-hover:animate-wiggle transition-transform duration-300 animate-bounce-light" style={{ animationDelay: '0.2s' }}>💡</div>
              <div>
          ...
          <div className="group bg-gradient-to-br from-slate-700/30 to-slate-800/30 backdrop-blur-md p-7 rounded-2xl border border-slate-600/40 hover:border-blue-400/60 transition-all duration-500 hover:bg-gradient-to-br hover:from-slate-700/50 hover:to-slate-800/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105 animate-fade-in-scale" style={{ animationDelay: '200ms' }}>
            <div className="flex items-start gap-4">
              <div className="text-4xl group-hover:scale-110 group-hover:animate-wiggle transition-transform duration-300 animate-bounce-light" style={{ animationDelay: '0.4s' }}>🌱</div>
              <div>
