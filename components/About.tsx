  ...
  return (
    ...
    >
      <div className={`section-enter mb-16 ${isInView ? 'active' : ''}`}>
        <h2 className={`text-4xl md:text-5xl font-bold mb-4 text-center md:text-left section-header-enter ${isInView ? 'active' : ''}`}>
          <span className="gradient-text">Tentang Saya</span>
        </h2>
        <p className={`text-gray-400 text-lg mb-6 content-fade-enter ${isInView ? 'active' : ''} delay-100`}>Mengenal lebih jauh tentang perjalanan saya</p>
      ...
      <div className="grid md:grid-cols-2 gap-14 lg:gap-16">
        <div className={`space-y-7 content-fade-enter ${isInView ? 'active' : ''} delay-300`}>
          ...
          <div className="pt-2">
            <a href="#contact" className="btn-primary inline-flex items-center gap-2 hover-lift-animation">
              Mari Terhubung
